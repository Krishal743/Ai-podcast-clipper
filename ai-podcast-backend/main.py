...
def process_clip(base_dir: str, original_video_path: str, s3_key: str, start_time: float, end_time: float, clip_index: int, transcript_segments: list):
    ...
    s3_client.upload_file(
        subtitle_output_path, "podcastclipper", output_s3_key)
...
class AiPodcastClipper:
    ...
    def identify_moments(self, transcript: dict):
        prompt = (
            "This is a podcast video transcript consisting of word, along with each word's start and end time. "
            "I am looking to create clips between a minimum of 30 and maximum of 60 seconds long. The clip should never exceed 60 seconds.\n\n"
            ...
            "- Format the output as a list of JSON objects, each representing a clip with 'start' and 'end' timestamps: "
            '[{"start": seconds, "end": seconds}, ...clip2, clip3]. The output should always be readable by the python json.loads function.\n'
        ...
        try:
            ...
            print(f"Error in identify_moments: {e}")
            return "[]"
